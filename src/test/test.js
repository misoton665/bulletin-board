...
var _user$project$ExampleTest$add = F2(
	function (x, y) {
		return x + y;
	});
var _user$project$ExampleTest$tests = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				A2(_user$project$ExampleTest$add, 1, 2),
				3))
		]));

var _user$project$TestMain$main = {
	main: _elm_community$elm_test$ElmTest$runSuite(_user$project$ExampleTest$tests)
};

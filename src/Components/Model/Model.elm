module Components.Model.Model exposing (Model, CommentField, initialModel, initialCommentField)

import Components.Application.Comment exposing (Comment)

type alias CommentField = {author: String, body: String}

type alias Model = {comments: List Comment, commentField: CommentField}
